...
public interface SAASAgentReportRepository extends JpaRepository<SAASAgentReportModel, String> {
	...
	@Query(value="SELECT\r\n" + 
			...
			"FROM allconnectutility.saas_agent_admin_report c WHERE c.agent_login = ?1", nativeQuery = true)
		SAASAgentReportModel getSaasReportToday(String agentLogin);
