...
public interface SAASAgentReportMTDRepository extends JpaRepository<SAASAgentReportMTDModel, String> {
	...
	@Query(value="SELECT\r\n"+
			...
			SAASAgentReportMTDModel getMTDSaasReport(String agentLogin);
